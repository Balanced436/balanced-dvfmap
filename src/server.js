...
const db_local = require("./routes/queryCommune");
const db_global = require("./routes/queryGlobal");
const db_iris = require("./routes/queryIRIS");
const db_intercommunale = require("./routes/queryIntercommunale");
...
app.get(
  "/api/intercommunale/prix_median/:codeinseeepci",
  db_intercommunale.prixMedian,
);
